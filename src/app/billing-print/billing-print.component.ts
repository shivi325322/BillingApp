...
export class BillingPrintComponent implements OnInit {
  ...
  basicDetails:any;
  fileName:any;
  constructor(private router:Router,private dataService:BillingService) { }
  ...
  generatePdf() {
    ...
    Email.send({
      ...
      Subject :'Bill payment successful at Synergy Physiotherapy and Sports Injury Rehab Clinic',
      Body : '<p>Dear <strong>'+ this.basicDetails.name + ',</strong></p><p>I hope this email finds you well. We wanted to notify you of the services we provided on '+ this.basicDetails._DOA +', a patient id is generated i.e <strong>'+this.basicDetails._id +'</strong>.Please keep it for future reference.</p></br><p>Best Regards,</p></br><p>Synergy Physiotherapy and Sports Injury Rehab Clinic</p>',
      // attachments: [
      //   {
      //     content: pdf,
      //     filename: 'file.pdf',
      ...
      //   }
      // ]
      }).then( message => {alert('Email Sent'), (error) => {
